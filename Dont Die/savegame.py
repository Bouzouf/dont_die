...
class GameData:
    """
    A class used for saving and loading game data.

    Also used to assist with User Acceptance Testing as it saves game data which can be used to analyse playtesting data.
    """
