...
class Loading(arcade.Window):
    """
    A class used to draw and operate the loading screen when generating a new game.
    """
    ...
    def setup(self,map_size_multiplier=1):
        ...
        """
        Sets up the loading screen and generates resources on the map

            Parameters:
                map_size_multiplier (float): Used to make the map dimensions larger my multiplying them by this number.
        
            Returns:
                resources (list): A list of Resource Class instances.
        """
